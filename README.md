...
3.	cve-2019-14271 容器逃逸(这个貌似和其他的是一样的：CVE-2019-5736、CVE- 2019-14271)
# 这个不管
...
6.	cve-2019-16884 容器逃逸(不行，这个是复现不了的，资料什么的都几乎很少，唯一的也试过)




7.	cve-2017-1002101 容器逃逸(不行，没得)


8.	cve-2019-11253 拒绝服务（不行，没得）



9.	cve-2019-9946 流量劫持（不行，没得）





10.	cve-2020-8554 中间人攻击（不行，没得）
